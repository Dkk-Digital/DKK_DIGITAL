...
import { register, login, getProfile, updateProfile, getAllUsers, updateUserRole, deleteUser, getUserStats, getUserActivity, getUserActivityStats } from '../controllers/authController.js';
